...
<td><ul>
<li><span data-ttu-id="63a2c-156">E-Mails</span><span class="sxs-lookup"><span data-stu-id="63a2c-156">Emails</span></span></li>
...
<li> <span data-ttu-id="63a2c-179">Postfachkontakte (es werden maximal drei E-Mail-Adressen pro Kontakt migriert)</span><span class="sxs-lookup"><span data-stu-id="63a2c-179">Mailbox contacts (a maximum of 3 email addresses per contact are migrated)</span></span> </li>
...
<li> <span data-ttu-id="63a2c-204">Externe Kontakte</span><span class="sxs-lookup"><span data-stu-id="63a2c-204">External contacts</span></span> </li>
...
## <a name="your-responsibilities"></a><span data-ttu-id="63a2c-221">Ihre Zuständigkeiten</span><span class="sxs-lookup"><span data-stu-id="63a2c-221">Your responsibilities</span></span>
...
<span data-ttu-id="63a2c-224">Sie führen außerdem die folgenden Aktivitäten speziell für Exchange-Migrationen aus:</span><span class="sxs-lookup"><span data-stu-id="63a2c-224">You also perform the following activities, specific to Exchange migrations:</span></span>
  ...
  -  <span data-ttu-id="63a2c-238">Unterstützen Ihrer Endbenutzer bei der Behebung von Problemen bei der clientbasierten Migration.</span><span class="sxs-lookup"><span data-stu-id="63a2c-238">Assist your end-users with remediation of client-side migration issues.</span></span>
...
<span data-ttu-id="63a2c-250">Unsere Datenmigrationsdienste migrieren Daten aus diesen Quellumgebungen:</span><span class="sxs-lookup"><span data-stu-id="63a2c-250">Our data migration services migrate data from these source environments:</span></span>
...
<td><ul>
<li> <span data-ttu-id="63a2c-290">Google Docs, Google Tabellen und Google Präsentationen (Dateien werden in das entsprechende Office-Format konvertiert), einschließlich derjenigen über 10 MB</span><span class="sxs-lookup"><span data-stu-id="63a2c-290">Google Docs, Sheets, and Slides (files are converted to the equivalent Office format), including those over 10 MB</span></span> </li>
...
<li> <span data-ttu-id="63a2c-315">Inhalte, die nicht im Besitz des Google Drive-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-315">Content not owned by the Google Drive account being migrated</span></span> </li>
...
## <a name="considerations"></a><span data-ttu-id="63a2c-396">Überlegungen</span><span class="sxs-lookup"><span data-stu-id="63a2c-396">Considerations</span></span>
...
<li> <span data-ttu-id="63a2c-435">Zusätzliche Dateimetadaten von der Dateiklassifizierungsinfrastruktur (File Classification Infrastructure, FCI)</span><span class="sxs-lookup"><span data-stu-id="63a2c-435">Additional file metadata provided by File Classification Infrastructure (FCI)</span></span> </li>
...
<li> <span data-ttu-id="63a2c-456">Berechtigungen für Dateien auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-456">User-level file permissions</span></span> </li>
...
<li> <span data-ttu-id="63a2c-470">Mitgliedschaftsberechtigungen für freigegebene Laufwerke (<strong>Hinweis</strong>: Verwenden Sie die Google Drive-Administratorberichte, um die Mitgliedschaften für freigegebene Laufwerke zu identifizieren.</span><span class="sxs-lookup"><span data-stu-id="63a2c-470">Shared drive membership permissions (<strong>Note</strong>: Use Google Drive Admin reports to identify shared drive memberships.</span></span> <span data-ttu-id="63a2c-471">Weisen Sie die Endbenutzer an, diese Mitgliedschaftseinstellungen auf dem Ziel vor der Migration zu konfigurieren.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-471">Instruct end users to configure these membership settings on the target before migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-472">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-472">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="63a2c-473"><strong>Box (Starter, Business, Enterprise)</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-473"><strong>Box (Starter, Business, Enterprise)</strong></span></span></td>
<td><span data-ttu-id="63a2c-474">Einzeln oder mehrstufig</span><span class="sxs-lookup"><span data-stu-id="63a2c-474">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-475">Dokumente</span><span class="sxs-lookup"><span data-stu-id="63a2c-475">Documents</span></span> </li>
<li> <span data-ttu-id="63a2c-476">Datei- und Ordnerstruktur</span><span class="sxs-lookup"><span data-stu-id="63a2c-476">File and folder structure</span></span> </li>
<li> <span data-ttu-id="63a2c-477">Berechtigungen für Ordner auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-477">User-level folder permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-478">Berechtigungen für Ordner auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-478">Group-level folder permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-479">Dateien unter 15 GB</span><span class="sxs-lookup"><span data-stu-id="63a2c-479">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="63a2c-480">Grundlegende Dokument- und Ordnermetadaten: </span><span class="sxs-lookup"><span data-stu-id="63a2c-480">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="63a2c-481">Erstellungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-481">Created date</span></span> </li>
<li> <span data-ttu-id="63a2c-482">Änderungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-482">Modified date</span></span> </li>
<li> <span data-ttu-id="63a2c-483">Erstellt von</span><span class="sxs-lookup"><span data-stu-id="63a2c-483">Created by</span></span> </li>
<li> <span data-ttu-id="63a2c-484">Zuletzt geändert von</span><span class="sxs-lookup"><span data-stu-id="63a2c-484">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="63a2c-485">Geteilte Inhalte, die im Besitz des Box-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-485">Shared content owned by the Box account being migrated</span></span> </li>
</ul></td>
<td><ul>
<li> <span data-ttu-id="63a2c-486">Besitzverlauf, frühere Versionen und Kommentare</span><span class="sxs-lookup"><span data-stu-id="63a2c-486">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="63a2c-487">Beschreibungen von Dateien und Ordnern</span><span class="sxs-lookup"><span data-stu-id="63a2c-487">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="63a2c-488">Berechtigungen für Dateien auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-488">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-489">Berechtigungen für Dateien auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-489">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-490">Box-Tags und erweiterte Metadaten</span><span class="sxs-lookup"><span data-stu-id="63a2c-490">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="63a2c-491">Attribute für Dateisperre</span><span class="sxs-lookup"><span data-stu-id="63a2c-491">File lock attributes</span></span> </li>
<li> <span data-ttu-id="63a2c-492">Konvertierung eingebetteter URLs im Inhalt</span><span class="sxs-lookup"><span data-stu-id="63a2c-492">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="63a2c-493">Gelöschte Elemente</span><span class="sxs-lookup"><span data-stu-id="63a2c-493">Trashed items</span></span> </li>
<li> <span data-ttu-id="63a2c-494">Beschädigte Dokumente und Dokumente, auf die nicht zugegriffen werden kann</span><span class="sxs-lookup"><span data-stu-id="63a2c-494">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="63a2c-495">Blockierte oder inaktive Benutzer</span><span class="sxs-lookup"><span data-stu-id="63a2c-495">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="63a2c-496">Box-Apps, Lesezeichen, Favoriten und Workflows</span><span class="sxs-lookup"><span data-stu-id="63a2c-496">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="63a2c-497">Inhalte, die nicht im Besitz des migrierten Box-Kontos sind</span><span class="sxs-lookup"><span data-stu-id="63a2c-497">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="63a2c-498">Berechtigungen und grundlegende Metadaten von externen Benutzern (<strong>Hinweis</strong>: Verwenden Sie Box-Berichte zum Identifizieren von Inhalten, die für externe Benutzer freigegeben wurden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-498">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="63a2c-499">Weisen Sie Endbenutzer an, Inhalte nach der Migration erneut für externe Benutzer freizugeben.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-499">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-500">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-500">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="63a2c-501"><strong>Dropbox für Teams (Standard und Erweitert)</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-501"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="63a2c-502">Einzeln oder mehrstufig</span><span class="sxs-lookup"><span data-stu-id="63a2c-502">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-503">Dokumente</span><span class="sxs-lookup"><span data-stu-id="63a2c-503">Documents</span></span> </li>
<li> <span data-ttu-id="63a2c-504">Datei- und Ordnerstruktur</span><span class="sxs-lookup"><span data-stu-id="63a2c-504">File and folder structure</span></span> </li>
<li> <span data-ttu-id="63a2c-505">Berechtigungen für Ordner auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-505">User-level folder permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-506">Berechtigungen für Ordner auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-506">Group-level folder permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-507">Dateien unter 15 GB</span><span class="sxs-lookup"><span data-stu-id="63a2c-507">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="63a2c-508">Grundlegende Dokument- und Ordnermetadaten: </span><span class="sxs-lookup"><span data-stu-id="63a2c-508">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="63a2c-509">Erstellungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-509">Created date</span></span> </li>
<li> <span data-ttu-id="63a2c-510">Änderungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-510">Modified date</span></span> </li>
<li> <span data-ttu-id="63a2c-511">Erstellt von</span><span class="sxs-lookup"><span data-stu-id="63a2c-511">Created by</span></span> </li>
<li> <span data-ttu-id="63a2c-512">Zuletzt geändert von</span><span class="sxs-lookup"><span data-stu-id="63a2c-512">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="63a2c-513">Freigegebene Teamordner und -inhalte</span><span class="sxs-lookup"><span data-stu-id="63a2c-513">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="63a2c-514">Geteilte Inhalte, die im Besitz des Dropbox-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-514">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul></td>
<td><ul>
<li> <span data-ttu-id="63a2c-515">Besitzverlauf, frühere Versionen und Kommentare</span><span class="sxs-lookup"><span data-stu-id="63a2c-515">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="63a2c-516">Beschreibungen von Dateien und Ordnern</span><span class="sxs-lookup"><span data-stu-id="63a2c-516">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="63a2c-517">Berechtigungen für Dateien auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-517">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-518">Berechtigungen für Dateien auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-518">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-519">Erweiterte Metadaten</span><span class="sxs-lookup"><span data-stu-id="63a2c-519">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="63a2c-520">Attribute für Dateisperre</span><span class="sxs-lookup"><span data-stu-id="63a2c-520">File lock attributes</span></span> </li>
<li> <span data-ttu-id="63a2c-521">Konvertierung eingebetteter URLs im Inhalt</span><span class="sxs-lookup"><span data-stu-id="63a2c-521">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="63a2c-522">Gelöschte Elemente</span><span class="sxs-lookup"><span data-stu-id="63a2c-522">Trashed items</span></span> </li>
<li> <span data-ttu-id="63a2c-523">Beschädigte Dokumente und Dokumente, auf die nicht zugegriffen werden kann</span><span class="sxs-lookup"><span data-stu-id="63a2c-523">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="63a2c-524">Nicht gemountete Dropbox-Ordner</span><span class="sxs-lookup"><span data-stu-id="63a2c-524">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="63a2c-525">Gelöschte oder getrennte Benutzer</span><span class="sxs-lookup"><span data-stu-id="63a2c-525">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="63a2c-526">Dropbox Paper, Showcases und Spaces</span><span class="sxs-lookup"><span data-stu-id="63a2c-526">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="63a2c-527">Dropbox-Apps und Favoriten (Pins/Sterne)</span><span class="sxs-lookup"><span data-stu-id="63a2c-527">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="63a2c-528">Inhalte, die nicht im Besitz des migrierten Dropbox-Kontos sind</span><span class="sxs-lookup"><span data-stu-id="63a2c-528">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="63a2c-529">Berechtigungen und grundlegende Metadaten von externen Benutzern (<strong>Hinweis</strong>: Verwenden Sie Dropbox-Berichte zum Identifizieren von Inhalten, die für externe Benutzer freigegeben wurden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-529">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="63a2c-530">Weisen Sie Endbenutzer an, Inhalte nach der Migration erneut für externe Benutzer freizugeben.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-530">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-531">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-531">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-onedrive-for-business-migrations"></a><span data-ttu-id="63a2c-532">#A0 für OneDrive for #A1</span><span class="sxs-lookup"><span data-stu-id="63a2c-532">FastTrack responsibilities for OneDrive for Business migrations</span></span>

<span data-ttu-id="63a2c-533">Während des Migrationsprojekts führen unsere FastTrack-Spezialisten Standardaktivitäten aus.</span><span class="sxs-lookup"><span data-stu-id="63a2c-533">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="63a2c-534">Einzelheiten hierzu finden Sie in den Informationen zu Datenmigrationszuständigkeiten unter [Prozess und Erwartungen](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="63a2c-534">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

## <a name="your-responsibilities"></a><span data-ttu-id="63a2c-535">Ihre Zuständigkeiten</span><span class="sxs-lookup"><span data-stu-id="63a2c-535">Your responsibilities</span></span>

<span data-ttu-id="63a2c-536">Während des Migrationsprojekts führen Sie Standardaktivitäten aus.</span><span class="sxs-lookup"><span data-stu-id="63a2c-536">You perform standard activities during the migration project.</span></span> <span data-ttu-id="63a2c-537">Einzelheiten hierzu finden Sie in den Informationen zu Datenmigrationszuständigkeiten unter [Prozess und Erwartungen](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="63a2c-537">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

<span data-ttu-id="63a2c-538">Sie führen außerdem die folgenden Aktivitäten speziell für OneDrive for Business-Migrationen aus:</span><span class="sxs-lookup"><span data-stu-id="63a2c-538">You also perform the following activities, specific to OneDrive for Business migrations:</span></span>

  - <span data-ttu-id="63a2c-539">Bereitstellen aller OneDrive for Business-Websites, die für Ihre Migrationsereignisse bestimmt sind.</span><span class="sxs-lookup"><span data-stu-id="63a2c-539">Provision all OneDrive for Business sites that will be targeted by your migration events.</span></span>

## <a name="migration-to-microsoft-teams-and-microsoft-365-groups"></a><span data-ttu-id="63a2c-540">Migration zu Microsoft Teams und Microsoft 365-Gruppen</span><span class="sxs-lookup"><span data-stu-id="63a2c-540">Migration to Microsoft Teams and Microsoft 365 Groups</span></span>

<span data-ttu-id="63a2c-541">Wenn Sie FastTrack verwenden, um Ihre Dateien zu Microsoft Teams und Microsoft 365-Gruppen zu migrieren, bieten wir Migrationsleitfäden und Datenmigrationsdienste.</span><span class="sxs-lookup"><span data-stu-id="63a2c-541">When you choose to use FastTrack to migrate your files to Microsoft Teams and Microsoft 365 Groups, we provide migration guidance and data migration services.</span></span> <span data-ttu-id="63a2c-542">Wir bieten Anleitungen, mit denen Sie Ihre Migration planen, Ihre Quellumgebungen und Teams und Microsoft 365-Gruppen konfigurieren und unsere Datenmigrationsdienste nutzen können, um Ihre Dateien zu migrieren.</span><span class="sxs-lookup"><span data-stu-id="63a2c-542">We provide guidance to help you plan your migration, configure your source environments and Teams and Microsoft 365 Groups, and leverage our data migration services to migrate your files.</span></span> <span data-ttu-id="63a2c-543">Sie erstellen und planen Ihre Migrationsereignisse.</span><span class="sxs-lookup"><span data-stu-id="63a2c-543">You create and schedule your migration events.</span></span> <span data-ttu-id="63a2c-544">Wir führen Migrationsereignisse gemäß Ihrem Zeitplan aus, überwachen deren Status und stellen Statusberichte bereit.</span><span class="sxs-lookup"><span data-stu-id="63a2c-544">We launch migration events in accordance with your schedule, monitor their progress, and provide status reports.</span></span> <span data-ttu-id="63a2c-545">Wenn Ihre Migrationsereignisse abgeschlossen sind, können Sie erwarten, dass Dateien aus entsprechend geplanten und berechtigten Quellen Ihrer Quellumgebungen zu Teams und Microsoft 365-Gruppen migriert wurden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-545">When your migration events are completed, you can expect files from appropriately scheduled and eligible sources of your source environments to have been migrated to Teams and Microsoft 365 Groups.</span></span> <span data-ttu-id="63a2c-546">Teams-Kanäle und Microsoft 365-Gruppen müssen vom Kunden vorab bereitgestellt werden, bevor sie Daten zu diesen Zieltypen migrieren können.</span><span class="sxs-lookup"><span data-stu-id="63a2c-546">Teams channels and Microsoft 365 Groups  must be pre-provisioned by the customer before they can migrate data into these destination types.</span></span> <span data-ttu-id="63a2c-547">Teams und Microsoft 365-Gruppen haben Auswirkungen auf Ihre Berechtigungen für den Dateizielspeicherort.</span><span class="sxs-lookup"><span data-stu-id="63a2c-547">Teams and Microsoft 365 Groups impacts your permissions on the file destination location.</span></span> <span data-ttu-id="63a2c-548">Teams und Microsoft 365-Gruppen sind so aufgebaut, dass die Zusammenarbeit ermöglicht wird.</span><span class="sxs-lookup"><span data-stu-id="63a2c-548">Teams and Microsoft 365 Groups are built to allow collaboration.</span></span> <span data-ttu-id="63a2c-549">Der Microsoft 365-Kanal oder die Microsoft 365-Gruppe bestimmen, wer bei der Migration zu diesen Zielen Zugriff auf diese Dateien hat.</span><span class="sxs-lookup"><span data-stu-id="63a2c-549">The Teams channel or Microsoft 365 group determine who has access to those files when migrating into those destinations.</span></span> <span data-ttu-id="63a2c-550">FastTrack fügt während der Migration keine Endbenutzer oder Gruppen zu einem Teams-Kanal oder zu Microsoft 365-Gruppen hinzu.</span><span class="sxs-lookup"><span data-stu-id="63a2c-550">FastTrack doesn't add end users or groups to any Teams channel or Microsoft 365 Groups permission during migration.</span></span>

## <a name="considerations"></a><span data-ttu-id="63a2c-551">Überlegungen</span><span class="sxs-lookup"><span data-stu-id="63a2c-551">Considerations</span></span>

- <span data-ttu-id="63a2c-552">Alle Migrationen unterliegen SharePoint Online-Kontingenten.</span><span class="sxs-lookup"><span data-stu-id="63a2c-552">All migrations are subject to SharePoint Online quotas.</span></span> <span data-ttu-id="63a2c-553">Weitere Informationen <a href="https://go.microsoft.com/fwlink/?LinkId=698855">finden Sie unter SharePoint-Grenzwerte.</a></span><span class="sxs-lookup"><span data-stu-id="63a2c-553">Refer to <a href="https://go.microsoft.com/fwlink/?LinkId=698855"> SharePoint limits</a> for details.</span></span> 
- <span data-ttu-id="63a2c-554">Der Gesamtbetrag sollte auf 75 Prozent des SharePoint Online-Gesamtspeicherkontingents, für das Sie berechtigt sind, beschränkt werden (einschließlich den zusätzlichen Speicher, den Sie möglicherweise separat gekauft haben).</span><span class="sxs-lookup"><span data-stu-id="63a2c-554">We recommend that you limit the overall amount of migrate to 75 percent of the overall SharePoint Online storage quota to which you are entitled (including the additional storage you may have purchased separately).</span></span> 


## <a name="source-environment-details"></a><span data-ttu-id="63a2c-555">Detail der Quellumgebung</span><span class="sxs-lookup"><span data-stu-id="63a2c-555">Source environment details</span></span>

<span data-ttu-id="63a2c-556">Unsere Datenmigrationsdienste migrieren Daten aus diesen Quellumgebungen:</span><span class="sxs-lookup"><span data-stu-id="63a2c-556">Our data migration services migrate data from these source environments:</span></span> 

- <span data-ttu-id="63a2c-557">Dateifreigaben (SMB [Server Message Block]-Dateifreigaben auf Geräten mit Unterstützung für SMB 2.0 und höher)</span><span class="sxs-lookup"><span data-stu-id="63a2c-557">File shares (Server Message Block (SMB) file shares on devices supporting SMB 2.0 onward).</span></span>
-  <span data-ttu-id="63a2c-558">Eine einzelne G Suite-Umgebung (nur Google Drive).</span><span class="sxs-lookup"><span data-stu-id="63a2c-558">A single G Suite environment (Google Drive only).</span></span> 
- <span data-ttu-id="63a2c-559">Box (Starter, Business, Enterprise).</span><span class="sxs-lookup"><span data-stu-id="63a2c-559">Box (Starter, Business, Enterprise).</span></span> 
- <span data-ttu-id="63a2c-560">Dropbox für Teams (Standard und Erweitert).</span><span class="sxs-lookup"><span data-stu-id="63a2c-560">Dropbox for Teams (Standard and Advanced).</span></span> 

<span data-ttu-id="63a2c-561">Die folgende Tabelle enthält die Migrationsdetails, die für die einzelnen Quellumgebungen gelten:</span><span class="sxs-lookup"><span data-stu-id="63a2c-561">The following table presents migration details specific to each source environment:</span></span>

<table>
<thead>
<tr class="header">
 <th><span data-ttu-id="63a2c-562"><strong>Quellumgebung</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-562"><strong>Source environment</strong></span></span></th>
 <th><span data-ttu-id="63a2c-563"><strong>Migrationstyp</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-563"><strong>Type of migration</strong></span></span></th>
 <th><span data-ttu-id="63a2c-564"><strong>Was wird migriert?</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-564"><strong>What migrates</strong></span></span></th>
 <th><span data-ttu-id="63a2c-565"><strong>Was wird nicht migriert?</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-565"><strong>What doesn't migrate</strong></span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><span data-ttu-id="63a2c-566"><strong>Alle Dateifreigabegeräte mit Unterstützung für SMB 2.0 und höher</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-566"><strong>Any file share device supporting SMB 2.0 onward</strong></span></span></td>
<td><span data-ttu-id="63a2c-567">Einzeln oder mehrstufig</span><span class="sxs-lookup"><span data-stu-id="63a2c-567">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-568">Dokumente</span><span class="sxs-lookup"><span data-stu-id="63a2c-568">Documents</span></span> </li>
<li> <span data-ttu-id="63a2c-569">Datei- und Ordnerstruktur</span><span class="sxs-lookup"><span data-stu-id="63a2c-569">File and folder structure</span></span> </li>
<li> <span data-ttu-id="63a2c-570">Datei- und Ordnerberechtigungen auf Benutzerebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-570">User-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-571">Datei- und Ordnerberechtigungen auf Gruppenebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-571">Group-level file and folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-572">Dateien unter 15 GB</span><span class="sxs-lookup"><span data-stu-id="63a2c-572">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="63a2c-573">Grundlegende Dokument- und Ordnermetadaten: </span><span class="sxs-lookup"><span data-stu-id="63a2c-573">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="63a2c-574">Erstellungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-574">Created date</span></span> </li>
<li> <span data-ttu-id="63a2c-575">Änderungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-575">Modified date</span></span> </li>
<li> <span data-ttu-id="63a2c-576">Erstellt von</span><span class="sxs-lookup"><span data-stu-id="63a2c-576">Created by</span></span> </li>
<li> <span data-ttu-id="63a2c-577">Zuletzt geändert von</span><span class="sxs-lookup"><span data-stu-id="63a2c-577">Last modified by</span></span> </li>
</ul></li>
</ul>
<br>
<span data-ttu-id="63a2c-578">\* Setzt die Konfiguration der Verzeichnissynchronisierung voraus.</span><span class="sxs-lookup"><span data-stu-id="63a2c-578">\*Directory synchronization configuration required.</span></span> <span data-ttu-id="63a2c-579">Es werden nur NTFS-Berechtigungen migriert, die für den Windows-Datei-Explorer verfügbar sind.</span><span class="sxs-lookup"><span data-stu-id="63a2c-579">Only NTFS permissions exposed to the Windows File Explorer are migrated.</span></span> <span data-ttu-id="63a2c-580">Berechtigungen, die direkt auf Dateifreigabegeräten verwaltet werden, werden nicht migriert.</span><span class="sxs-lookup"><span data-stu-id="63a2c-580">Permissions managed directly on file share devices are not migrated.</span></span> <span data-ttu-id="63a2c-581">Wenn Daten auf einem SMB 2.0-Gerät gespeichert werden, werden die NTFS-äquivalenten Berechtigungen, die vom SMB-Protokoll verfügbar gemacht werden, migriert.</span><span class="sxs-lookup"><span data-stu-id="63a2c-581">If data is stored on an SMB 2.0 device, the NTFS-equivalent permissions exposed by the SMB protocol are migrated.</span></span> <span data-ttu-id="63a2c-582">Berechtigungen werden vom Microsoft 365-Gruppen- und/oder Microsoft Teams-Kanal betroffen.</span><span class="sxs-lookup"><span data-stu-id="63a2c-582">Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="63a2c-583">Wenn es sich bei dem Ziel um einen Microsoft 365-Gruppen- oder Microsoft Teams-Kanal handelt, bestimmt die Gruppe oder der Kanal das endgültige Berechtigungsprofil für migrierte Dateien.</span><span class="sxs-lookup"><span data-stu-id="63a2c-583">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="63a2c-584">Es wird empfohlen, keine Berechtigungen für Dateien zu migrieren, die zu einem Microsoft 365-Gruppen- oder Microsoft Teams-Kanal migriert werden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-584">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-585">Besitzverlauf und frühere Versionen</span><span class="sxs-lookup"><span data-stu-id="63a2c-585">Ownership history and previous versions</span></span> </li>
<li> <span data-ttu-id="63a2c-586">Konvertierung eingebetteter URLs im Inhalt</span><span class="sxs-lookup"><span data-stu-id="63a2c-586">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="63a2c-587">Frühere Versionen</span><span class="sxs-lookup"><span data-stu-id="63a2c-587">Previous versions</span></span> </li>
<li> <span data-ttu-id="63a2c-588">Windows-Datei-/-Ordnerattribute (z. B. „Schreibgeschützt“ und „Ausgeblendet“) </span><span class="sxs-lookup"><span data-stu-id="63a2c-588">Windows file and folder attributes (like read-only and hidden)</span></span> </li>
<li> <span data-ttu-id="63a2c-589">Nicht-Windows-NTFS-Dateisystem (New Technology File System) und erweiterte NTFS-Berechtigungen sowie besondere Einstellungen:</span><span class="sxs-lookup"><span data-stu-id="63a2c-589">Non-Windows New Technology File System (NTFS) and NTFS advanced permissions and special settings:</span></span> </li>
<li> <span data-ttu-id="63a2c-590">Explizite Verweigerungsberechtigungen (werden nach der Migration entfernt, Inhalte unterliegen parallelen Berechtigungen oder Berechtigungen im übergeordneten Ordner).</span><span class="sxs-lookup"><span data-stu-id="63a2c-590">Explicit deny permissions (removed after migration, content subject to parallel permissions or permissions on parent folder)</span></span> </li>
<li> <span data-ttu-id="63a2c-591">Konfiguration der NTFS-Überwachung</span><span class="sxs-lookup"><span data-stu-id="63a2c-591">NTFS auditing configuration</span></span> </li>
<li> <span data-ttu-id="63a2c-592">Zusätzliche Dateimetadaten von der Dateiklassifizierungsinfrastruktur (File Classification Infrastructure, FCI)</span><span class="sxs-lookup"><span data-stu-id="63a2c-592">Additional file metadata provided by File Classification Infrastructure (FCI)</span></span> </li>
<li> <span data-ttu-id="63a2c-593">Beschädigte Dokumente und Dokumente, auf die nicht zugegriffen werden kann</span><span class="sxs-lookup"><span data-stu-id="63a2c-593">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="63a2c-594">Ausgeblendete Freigaben</span><span class="sxs-lookup"><span data-stu-id="63a2c-594">Hidden shares</span></span> </li>
<li> <span data-ttu-id="63a2c-595">Freigabe (z. B. gewährte Berechtigungen auf Freigabeebene)</span><span class="sxs-lookup"><span data-stu-id="63a2c-595">Sharing (like permissions granted on the share level)</span></span> </li>
<li> <span data-ttu-id="63a2c-596">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-596">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="63a2c-597"><strong>Einzelne G Suite-Umgebung (nur Google Drive)</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-597"><strong>Single G Suite environment (Google Drive only)</strong></span></span></td>
<td><span data-ttu-id="63a2c-598">Einzeln oder mehrstufig</span><span class="sxs-lookup"><span data-stu-id="63a2c-598">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-599">Google Docs, Google Tabellen und Google Präsentationen (Dateien werden in das entsprechende Office-Format konvertiert, einschließlich derjenigen über 10 MB)</span><span class="sxs-lookup"><span data-stu-id="63a2c-599">Google Docs, Sheets, and Slides (files are converted to the equivalent Office format including those over 10 MB)</span></span> </li>
<li> <span data-ttu-id="63a2c-600">Datei- und Ordnerstruktur</span><span class="sxs-lookup"><span data-stu-id="63a2c-600">File and folder structure</span></span> </li>
<li> <span data-ttu-id="63a2c-601">Ordnerberechtigungen auf Benutzerebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-601">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-602">Ordnerberechtigungen auf Gruppenebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-602">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-603">Dateien unter 15 GB</span><span class="sxs-lookup"><span data-stu-id="63a2c-603">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="63a2c-604">Grundlegende Dokument- und Ordnermetadaten: </span><span class="sxs-lookup"><span data-stu-id="63a2c-604">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="63a2c-605">Erstellungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-605">Created date</span></span> </li>
<li> <span data-ttu-id="63a2c-606">Änderungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-606">Modified date</span></span> </li>
<li> <span data-ttu-id="63a2c-607">Erstellt von</span><span class="sxs-lookup"><span data-stu-id="63a2c-607">Created by</span></span> </li>
<li> <span data-ttu-id="63a2c-608">Zuletzt geändert von</span><span class="sxs-lookup"><span data-stu-id="63a2c-608">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="63a2c-609">Freigegebene Laufwerke (Ordner und Dateien)</span><span class="sxs-lookup"><span data-stu-id="63a2c-609">Shared drives (folders and files)</span></span> </li>
<li> <span data-ttu-id="63a2c-610">Geteilte Inhalte, die im Besitz des Google Drive-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-610">Shared content owned by the Google Drive account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="63a2c-611">\*Berechtigungen werden vom Microsoft 365-Gruppen- und/oder Microsoft #A0 betroffen.</span><span class="sxs-lookup"><span data-stu-id="63a2c-611">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="63a2c-612">Wenn es sich bei dem Ziel um einen Microsoft 365-Gruppen- oder Microsoft Teams-Kanal handelt, bestimmt die Gruppe oder der Kanal das endgültige Berechtigungsprofil für migrierte Dateien.</span><span class="sxs-lookup"><span data-stu-id="63a2c-612">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="63a2c-613">Es wird empfohlen, keine Berechtigungen für Dateien zu migrieren, die zu einem Microsoft 365-Gruppen- oder Microsoft Teams-Kanal migriert werden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-613">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> 
</td>
<td><ul>
<li> <span data-ttu-id="63a2c-614">Besitzverlauf, frühere Versionen und Kommentare</span><span class="sxs-lookup"><span data-stu-id="63a2c-614">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="63a2c-615">Beschreibungen von Dateien und Ordnern, Ordnerfarben</span><span class="sxs-lookup"><span data-stu-id="63a2c-615">File and folder descriptions, folder colors</span></span> </li>
<li> <span data-ttu-id="63a2c-616">Berechtigungen für Dateien auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-616">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-617">Berechtigungen für Dateien auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-617">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-618">Erweiterte Metadaten</span><span class="sxs-lookup"><span data-stu-id="63a2c-618">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="63a2c-619">Attribute für Dateisperre</span><span class="sxs-lookup"><span data-stu-id="63a2c-619">File lock attributes</span></span> </li>
<li> <span data-ttu-id="63a2c-620">Konvertierung eingebetteter URLs im Inhalt</span><span class="sxs-lookup"><span data-stu-id="63a2c-620">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="63a2c-621">Gelöschte Elemente</span><span class="sxs-lookup"><span data-stu-id="63a2c-621">Trashed items</span></span> </li>
<li> <span data-ttu-id="63a2c-622">Beschädigte Dokumente und Dokumente, auf die nicht zugegriffen werden kann</span><span class="sxs-lookup"><span data-stu-id="63a2c-622">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="63a2c-623">Blockierte oder inaktive Benutzer</span><span class="sxs-lookup"><span data-stu-id="63a2c-623">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="63a2c-624">Google Fotos, Google Formulare, Google Maps und andere verbundene Apps</span><span class="sxs-lookup"><span data-stu-id="63a2c-624">Google Photos Forms, Maps, and other connected apps</span></span> </li>
<li> <span data-ttu-id="63a2c-625">Google Zeichnungen</span><span class="sxs-lookup"><span data-stu-id="63a2c-625">Google Drawings</span></span> </li>
<li> <span data-ttu-id="63a2c-626">Freigegebene Inhalte außerhalb Ihrer Organisation</span><span class="sxs-lookup"><span data-stu-id="63a2c-626">Shared content external to your organization</span></span> </li>
<li> <span data-ttu-id="63a2c-627">Inhalte, die nicht im Besitz des Google Drive-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-627">Content not owned by the Google Drive account being migrated</span></span> </li>
<li> <span data-ttu-id="63a2c-628">Berechtigungen und grundlegende Metadaten von externen Benutzern (<strong>Hinweis</strong>: Verwenden Sie Google Drive-Administratorberichte zum Identifizieren von Inhalten, die für externe Benutzer freigegeben wurden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-628">Permissions and basic metadata of external users (<strong>Note</strong>: Use Google Drive Admin reports to identify content shared with external users.</span></span> <span data-ttu-id="63a2c-629">Weisen Sie Endbenutzer an, Inhalte nach der Migration erneut für externe Benutzer freizugeben.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-629">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-630">Mitgliedschaftsberechtigungen für freigegebene Laufwerke (<strong>Hinweis</strong>: Verwenden Sie die Google Drive-Administratorberichte, um die Mitgliedschaften für freigegebene Laufwerke zu identifizieren.</span><span class="sxs-lookup"><span data-stu-id="63a2c-630">Shared drive membership permissions (<strong>Note</strong>: Use Google Drive Admin reports to identify shared drive memberships.</span></span> <span data-ttu-id="63a2c-631">Weisen Sie die Endbenutzer an, diese Mitgliedschaftseinstellungen auf dem Ziel vor der Migration zu konfigurieren.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-631">Instruct end users to configure these membership settings on the target before migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-632">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-632">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="63a2c-633"><strong>Box (Starter, Business, Enterprise)</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-633"><strong>Box (Starter, Business, Enterprise)</strong></span></span></td>
<td><span data-ttu-id="63a2c-634">Einzeln oder mehrstufig</span><span class="sxs-lookup"><span data-stu-id="63a2c-634">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-635">Dokumente</span><span class="sxs-lookup"><span data-stu-id="63a2c-635">Documents</span></span> </li>
<li> <span data-ttu-id="63a2c-636">Datei- und Ordnerstruktur</span><span class="sxs-lookup"><span data-stu-id="63a2c-636">File and folder structure</span></span> </li>
<li> <span data-ttu-id="63a2c-637">Ordnerberechtigungen auf Benutzerebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-637">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-638">Ordnerberechtigungen auf Gruppenebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-638">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-639">Dateien unter 15 GB</span><span class="sxs-lookup"><span data-stu-id="63a2c-639">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="63a2c-640">Grundlegende Dokument- und Ordnermetadaten: </span><span class="sxs-lookup"><span data-stu-id="63a2c-640">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="63a2c-641">Erstellungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-641">Created date</span></span> </li>
<li> <span data-ttu-id="63a2c-642">Änderungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-642">Modified date</span></span> </li>
<li> <span data-ttu-id="63a2c-643">Erstellt von</span><span class="sxs-lookup"><span data-stu-id="63a2c-643">Created by</span></span> </li>
<li> <span data-ttu-id="63a2c-644">Zuletzt geändert von</span><span class="sxs-lookup"><span data-stu-id="63a2c-644">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="63a2c-645">Geteilte Inhalte, die im Besitz des Box-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-645">Shared content owned by the Box account being migrated</span></span> </li>
<li> <span data-ttu-id="63a2c-646">Box Notes (in Word-Dokumentformat konvertiert)</span><span class="sxs-lookup"><span data-stu-id="63a2c-646">Box Notes (converted to Word document format)</span></span> </li>
</ul>
<br>
<span data-ttu-id="63a2c-647">\*Berechtigungen werden vom Microsoft 365-Gruppen- und/oder Microsoft #A0 betroffen.</span><span class="sxs-lookup"><span data-stu-id="63a2c-647">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="63a2c-648">Wenn es sich bei dem Ziel um einen Microsoft 365-Gruppen- oder Microsoft Teams-Kanal handelt, bestimmt die Gruppe oder der Kanal das endgültige Berechtigungsprofil für migrierte Dateien.</span><span class="sxs-lookup"><span data-stu-id="63a2c-648">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="63a2c-649">Es wird empfohlen, keine Berechtigungen für Dateien zu migrieren, die zu einem Microsoft 365-Gruppen- oder Microsoft Teams-Kanal migriert werden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-649">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span> </td>
<td><ul>
<li> <span data-ttu-id="63a2c-650">Besitzverlauf, frühere Versionen und Kommentare</span><span class="sxs-lookup"><span data-stu-id="63a2c-650">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="63a2c-651">Beschreibungen von Dateien und Ordnern</span><span class="sxs-lookup"><span data-stu-id="63a2c-651">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="63a2c-652">Berechtigungen für Dateien auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-652">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-653">Berechtigungen für Dateien auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-653">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-654">Box-Tags und erweiterte Metadaten</span><span class="sxs-lookup"><span data-stu-id="63a2c-654">Box Tags and advanced metadata</span></span> </li>
<li> <span data-ttu-id="63a2c-655">Attribute für Dateisperre</span><span class="sxs-lookup"><span data-stu-id="63a2c-655">File lock attributes</span></span> </li>
<li> <span data-ttu-id="63a2c-656">Konvertierung eingebetteter URLs im Inhalt</span><span class="sxs-lookup"><span data-stu-id="63a2c-656">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="63a2c-657">Gelöschte Elemente</span><span class="sxs-lookup"><span data-stu-id="63a2c-657">Trashed items</span></span> </li>
<li> <span data-ttu-id="63a2c-658">Beschädigte Dokumente und Dokumente, auf die nicht zugegriffen werden kann</span><span class="sxs-lookup"><span data-stu-id="63a2c-658">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="63a2c-659">Blockierte oder inaktive Benutzer</span><span class="sxs-lookup"><span data-stu-id="63a2c-659">Blocked or inactive users</span></span> </li>
<li> <span data-ttu-id="63a2c-660">Box-Apps, Lesezeichen, Favoriten und Workflows</span><span class="sxs-lookup"><span data-stu-id="63a2c-660">Box Apps, Bookmarks, Favorites, and Workflows</span></span> </li>
<li> <span data-ttu-id="63a2c-661">Inhalte, die nicht im Besitz des migrierten Box-Kontos sind</span><span class="sxs-lookup"><span data-stu-id="63a2c-661">Content not owned by the migrated Box account</span></span> </li>
<li> <span data-ttu-id="63a2c-662">Berechtigungen und grundlegende Metadaten von externen Benutzern (<strong>Hinweis</strong>: Verwenden Sie Box-Berichte zum Identifizieren von Inhalten, die für externe Benutzer freigegeben wurden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-662">Permissions and basic metadata of external users (<strong>Note</strong>: Use Box reports to identify content shared with external users.</span></span> <span data-ttu-id="63a2c-663">Weisen Sie Endbenutzer an, Inhalte nach der Migration erneut für externe Benutzer freizugeben.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-663">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-664">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-664">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
<tr class="even">
<td><span data-ttu-id="63a2c-665"><strong>Dropbox für Teams (Standard und Erweitert)</strong></span><span class="sxs-lookup"><span data-stu-id="63a2c-665"><strong>Dropbox for Teams (Standard and Advanced)</strong></span></span></td>
<td><span data-ttu-id="63a2c-666">Einzeln oder mehrstufig</span><span class="sxs-lookup"><span data-stu-id="63a2c-666">Single or multi-pass</span></span></td>
<td><ul>
<li> <span data-ttu-id="63a2c-667">Dokumente</span><span class="sxs-lookup"><span data-stu-id="63a2c-667">Documents</span></span> </li>
<li> <span data-ttu-id="63a2c-668">Datei- und Ordnerstruktur</span><span class="sxs-lookup"><span data-stu-id="63a2c-668">File and folder structure</span></span> </li>
<li> <span data-ttu-id="63a2c-669">Ordnerberechtigungen auf Benutzerebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-669">User-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-670">Ordnerberechtigungen auf Gruppenebene\*</span><span class="sxs-lookup"><span data-stu-id="63a2c-670">Group-level folder permissions\*</span></span> </li>
<li> <span data-ttu-id="63a2c-671">Dateien unter 15 GB</span><span class="sxs-lookup"><span data-stu-id="63a2c-671">Files under 15 GB</span></span> </li>
<li> <span data-ttu-id="63a2c-672">Grundlegende Dokument- und Ordnermetadaten: </span><span class="sxs-lookup"><span data-stu-id="63a2c-672">Basic document and folder metadata:</span></span>
<ul>
<li> <span data-ttu-id="63a2c-673">Erstellungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-673">Created date</span></span> </li>
<li> <span data-ttu-id="63a2c-674">Änderungsdatum</span><span class="sxs-lookup"><span data-stu-id="63a2c-674">Modified date</span></span> </li>
<li> <span data-ttu-id="63a2c-675">Erstellt von</span><span class="sxs-lookup"><span data-stu-id="63a2c-675">Created by</span></span> </li>
<li> <span data-ttu-id="63a2c-676">Zuletzt geändert von</span><span class="sxs-lookup"><span data-stu-id="63a2c-676">Last modified by</span></span> </li>
</ul></li>
<li> <span data-ttu-id="63a2c-677">Freigegebene Teamordner und -inhalte</span><span class="sxs-lookup"><span data-stu-id="63a2c-677">Shared team folders and content</span></span> </li>
<li> <span data-ttu-id="63a2c-678">Geteilte Inhalte, die im Besitz des Dropbox-Kontos sind, das migriert wird</span><span class="sxs-lookup"><span data-stu-id="63a2c-678">Shared content owned by the Dropbox account being migrated</span></span> </li>
</ul>
<br>
<span data-ttu-id="63a2c-679">\*Berechtigungen werden vom Microsoft 365-Gruppen- und/oder Microsoft #A0 betroffen.</span><span class="sxs-lookup"><span data-stu-id="63a2c-679">\*Permissions are impacted by the Microsoft 365 Group and/or Microsoft Teams channel.</span></span> <span data-ttu-id="63a2c-680">Wenn es sich bei dem Ziel um einen Microsoft 365-Gruppen- oder Microsoft Teams-Kanal handelt, bestimmt die Gruppe oder der Kanal das endgültige Berechtigungsprofil für migrierte Dateien.</span><span class="sxs-lookup"><span data-stu-id="63a2c-680">If the destination is a Microsoft 365 Group or Microsoft Teams channel, the group or channel determines the final permissions profile on migrated files.</span></span> <span data-ttu-id="63a2c-681">Es wird empfohlen, keine Berechtigungen für Dateien zu migrieren, die zu einem Microsoft 365-Gruppen- oder Microsoft Teams-Kanal migriert werden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-681">We recommend not migrating permissions on files migrating to a Microsoft 365 Group or Microsoft Teams channel.</span></span>
</td>
<td><ul>
<li> <span data-ttu-id="63a2c-682">Besitzverlauf, frühere Versionen und Kommentare</span><span class="sxs-lookup"><span data-stu-id="63a2c-682">Ownership history, previous versions, and comments</span></span> </li>
<li> <span data-ttu-id="63a2c-683">Beschreibungen von Dateien und Ordnern</span><span class="sxs-lookup"><span data-stu-id="63a2c-683">File and folder descriptions</span></span> </li>
<li> <span data-ttu-id="63a2c-684">Berechtigungen für Dateien auf Benutzerebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-684">User-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-685">Berechtigungen für Dateien auf Gruppenebene</span><span class="sxs-lookup"><span data-stu-id="63a2c-685">Group-level file permissions</span></span> </li>
<li> <span data-ttu-id="63a2c-686">Erweiterte Metadaten</span><span class="sxs-lookup"><span data-stu-id="63a2c-686">Advanced metadata</span></span> </li>
<li> <span data-ttu-id="63a2c-687">Attribute für Dateisperre</span><span class="sxs-lookup"><span data-stu-id="63a2c-687">File lock attributes</span></span> </li>
<li> <span data-ttu-id="63a2c-688">Konvertierung eingebetteter URLs im Inhalt</span><span class="sxs-lookup"><span data-stu-id="63a2c-688">Conversion of embedded URLs in content</span></span> </li>
<li> <span data-ttu-id="63a2c-689">Gelöschte Elemente</span><span class="sxs-lookup"><span data-stu-id="63a2c-689">Trashed items</span></span> </li>
<li> <span data-ttu-id="63a2c-690">Beschädigte Dokumente und Dokumente, auf die nicht zugegriffen werden kann</span><span class="sxs-lookup"><span data-stu-id="63a2c-690">Inaccessible or corrupted documents</span></span> </li>
<li> <span data-ttu-id="63a2c-691">Nicht gemountete Dropbox-Ordner</span><span class="sxs-lookup"><span data-stu-id="63a2c-691">Unmounted Dropbox folders</span></span> </li>
<li> <span data-ttu-id="63a2c-692">Gelöschte oder getrennte Benutzer</span><span class="sxs-lookup"><span data-stu-id="63a2c-692">Deleted or disconnected users</span></span> </li>
<li> <span data-ttu-id="63a2c-693">Dropbox Paper, Showcases und Spaces</span><span class="sxs-lookup"><span data-stu-id="63a2c-693">Dropbox Paper, Showcases, and Spaces</span></span> </li>
<li> <span data-ttu-id="63a2c-694">Dropbox-Apps und Favoriten (Pins/Sterne)</span><span class="sxs-lookup"><span data-stu-id="63a2c-694">Dropbox Apps and Favorites (Pins/Stars)</span></span> </li>
<li> <span data-ttu-id="63a2c-695">Inhalte, die nicht im Besitz des migrierten Dropbox-Kontos sind</span><span class="sxs-lookup"><span data-stu-id="63a2c-695">Content not owned by the migrated Dropbox account</span></span> </li>
<li> <span data-ttu-id="63a2c-696">Berechtigungen und grundlegende Metadaten von externen Benutzern (<strong>Hinweis</strong>: Verwenden Sie Dropbox-Berichte zum Identifizieren von Inhalten, die für externe Benutzer freigegeben wurden.</span><span class="sxs-lookup"><span data-stu-id="63a2c-696">Permissions and basic metadata of external users (<strong>Note</strong>: Use Dropbox reports to identify content shared with external users.</span></span> <span data-ttu-id="63a2c-697">Weisen Sie Endbenutzer an, Inhalte nach der Migration erneut für externe Benutzer freizugeben.)</span><span class="sxs-lookup"><span data-stu-id="63a2c-697">Instruct end users to reshare content with external users after migration.)</span></span> </li>
<li> <span data-ttu-id="63a2c-698">Dateien oder Ordner, die aktuelle <a href="https://go.microsoft.com/fwlink/?linkid=846724"> <span class="underline">SharePoint Online-Einschränkungen und -Einschränkungen überschreiten</span></a> </span><span class="sxs-lookup"><span data-stu-id="63a2c-698">Files or folders exceeding current <a href="https://go.microsoft.com/fwlink/?linkid=846724"><span class="underline">SharePoint Online restrictions and limitations</span></a> </span></span></li>
</ul></td>
</tr>
</tbody>
</table>

## <a name="fasttrack-responsibilities-for-microsoft-teams-and-microsoft-365-groups-migrations"></a><span data-ttu-id="63a2c-699">FastTrack-Verantwortlichkeiten für Migrationen von Microsoft Teams und Microsoft 365-Gruppen</span><span class="sxs-lookup"><span data-stu-id="63a2c-699">FastTrack responsibilities for Microsoft Teams and Microsoft 365 Groups migrations</span></span>

<span data-ttu-id="63a2c-700">Während des Migrationsprojekts führen unsere FastTrack-Spezialisten Standardaktivitäten aus.</span><span class="sxs-lookup"><span data-stu-id="63a2c-700">Our FastTrack Specialists perform standard activities during the migration project.</span></span> <span data-ttu-id="63a2c-701">Einzelheiten hierzu finden Sie in den Informationen zu Datenmigrationszuständigkeiten unter [Prozess und Erwartungen](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="63a2c-701">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>

## <a name="your-responsibilities"></a><span data-ttu-id="63a2c-702">Ihre Zuständigkeiten</span><span class="sxs-lookup"><span data-stu-id="63a2c-702">Your responsibilities</span></span> 

<span data-ttu-id="63a2c-703">Während des Migrationsprojekts führen Sie Standardaktivitäten aus.</span><span class="sxs-lookup"><span data-stu-id="63a2c-703">You perform standard activities during the migration project.</span></span> <span data-ttu-id="63a2c-704">Einzelheiten hierzu finden Sie in den Informationen zu Datenmigrationszuständigkeiten unter [Prozess und Erwartungen](process-and-expectations.md).</span><span class="sxs-lookup"><span data-stu-id="63a2c-704">Refer to the data migration responsibilities information in [Process and Expectations](process-and-expectations.md) for details.</span></span>
<span data-ttu-id="63a2c-705">Sie führen außerdem die folgenden Aktivitäten aus, die speziell für Migrationen von Microsoft Teams und Microsoft 365-Gruppen verwendet werden:</span><span class="sxs-lookup"><span data-stu-id="63a2c-705">You also perform the following activities, specific to Microsoft Teams and Microsoft 365 Groups migrations:</span></span> 

- <span data-ttu-id="63a2c-706">Bereitstellen aller Microsoft Teams-Kanäle und Microsoft 365-Gruppen, die auf Ihre Migrationsereignisse ausgerichtet sind.</span><span class="sxs-lookup"><span data-stu-id="63a2c-706">Provision all Microsoft Teams channels and Microsoft 365 Groups as targeted by your migration events.</span></span>

> [!NOTE]
><span data-ttu-id="63a2c-707">FastTrack stellt keine Microsoft Teams-Kanäle oder Microsoft 365-Gruppen vorab zur Verfügung.</span><span class="sxs-lookup"><span data-stu-id="63a2c-707">FastTrack doesn't pre-provision Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="63a2c-708">FastTrack fügt keine Endbenutzer oder Gruppen zu Microsoft Teams-Kanälen oder Microsoft 365-Gruppen hinzu.</span><span class="sxs-lookup"><span data-stu-id="63a2c-708">FastTrack doesn't add end users or groups to Microsoft Teams channels or Microsoft 365 Groups.</span></span> <span data-ttu-id="63a2c-709">Sie müssen Ihre Endbenutzer oder Gruppen zu allen Microsoft Teams-Kanälen und Microsoft 365-Gruppen hinzufügen, bevor Sie Daten zu diesen Zielen migrieren, damit diese Endbenutzer Zugriff auf diese neu migrierten Dokumente haben.</span><span class="sxs-lookup"><span data-stu-id="63a2c-709">You must add your end users or groups to all Microsoft Teams channels and Microsoft 365 Groups before you migrate data into those destinations so those end users have access to those newly migrated documents</span></span>