...
Kunden, die mindestens 20.000 Lizenzen für einen Exchange Online Mandanten erwerben, sind für weitere Services des Zentrums berechtigt. Weitere Informationen finden Sie unter [Berechtigung](eligibility.md) . 
...
Zu den Zuständigkeiten von FastTrack-Experten während des Onboardings zählen die folgenden: Diese können zusätzlich zu den in [Process und Erwartungen](process-and-expectations.md)definierten Aktivitäten oder ersetzen.
  
## <a name="general"></a>Allgemein

- Bereitstellen von Remote Support Unterstützung für Sie bei der Planung der Entwicklung, Implementierung und der erforderlichen Konfigurationsaktivitäten, wie in [Produkte und Funktionen](products-and-capabilities.md)beschrieben.
...
Zu Ihren Zuständigkeiten während des Onboardings zählen die folgenden: Diese werden zusätzlich zu den in [Process und Erwartungen](process-and-expectations.md)definierten Zuständigkeiten hinzugefügt. 
